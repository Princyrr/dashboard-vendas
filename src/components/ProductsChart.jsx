...
const ProductsChart = () => {
  const data = [
    { name: 'Smartphones', value: 35, color: '#00ff88' },
    { name: 'Laptops', value: 25, color: '#10b981' },
    { name: 'Fones', value: 20, color: '#34d399' },
    { name: 'Tablets', value: 12, color: '#6ee7b7' },
    { name: 'Outros', value: 8, color: '#9cf3d3' },
  ]
  ...
  return (
    <div className="bg-dark-card p-6 rounded-xl border border-gray-700 h-full">
      <h2 className="text-xl font-semibold mb-6 text-white">Produtos Mais Vendidos</h2>
      <div className="h-64">
